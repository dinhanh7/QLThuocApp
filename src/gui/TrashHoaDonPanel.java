...
public class TrashHoaDonPanel extends JPanel {
    ...
    public TrashHoaDonPanel(JTabbedPane tabbedPane, int index) {
        ...
        btnRefresh.setIcon(new ImageIcon(TrashHoaDonPanel.class.getResource("/icon/chungRefresh.png")));
        JButton btnRestore = new JButton("Khôi phục");
        btnRestore.setIcon(new ImageIcon(TrashHoaDonPanel.class.getResource("/icon/ChungUndo.png")));
        JButton btnDeleteForever = new JButton("Xóa vĩnh viễn");
        btnDeleteForever.setIcon(new ImageIcon(TrashHoaDonPanel.class.getResource("/icon/chungTrash.png")));
